...
/* ─── RULES ─── */
const RULES = [
  "Round 3 contains 30 bugs to identify and fix.",
  "Each fixed bug carries 5 marks for a maximum of 150.",
  "The round duration is 60 minutes.",
  "Tab switching is monitored and repeated violations flag the session.",
  "Copy-paste and right click can be restricted during the arena.",
  "If the timer reaches zero, your current code is auto-submitted.",
];
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <p style={{ ...lbl, color: "rgba(56,189,248,0.65)", marginBottom: "5px" }}>Round 3 · Confirmation</p>
        ...
        <div style={{ padding: "20px 22px" }}>
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                <strong style={{ color: "#7dd3fc" }}>60-minute</strong> countdown begins and cannot be paused.
          ...
          <p style={{ fontSize: "12px", color: "rgba(148,163,184,0.5)", fontFamily: "'Inter',sans-serif" }}>
            Tab switches are monitored. Repeated violations will flag your session.
          </p>
        </div>
...
/* ══════════════════════════════════════════
   MAIN PAGE
══════════════════════════════════════════ */
export default function Round3TermsPage() {
  const navigate = useNavigate();
  const { agreedToTerms, acceptTerms, selectedLanguage, submitResult } = useRound3Battle();

  const [agreed,        setAgreed]        = useState(agreedToTerms ?? false);
  ...
  const durationLabel = useMemo(() => "60 minutes", []);
  ...
  useEffect(() => {
    ...
    const bootstrap = async () => {
      try {
        ...
        // Add any pre-flight checks here (e.g. fetch session status)
      } catch (err) {
        if (!active) return;
  ...
  const handleConfirm = async () => {
    ...
    setError("");
    try {
      navigate("/team/round3/language", { replace: true });
    } catch (err) {
      setError("Failed to start Round 3. Please try again.");
      ...
      >
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
              ...
              <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                <div style={{
                  ...
                  <span style={{ ...lbl, fontSize: "8px", color: "rgba(56,189,248,0.6)" }}>Duration</span>
                  <span style={{ ...mono, fontSize: "12px", fontWeight: 700, color: "#38bdf8" }}>{durationLabel}</span>
                </div>
                <div style={{
                  display: "flex", alignItems: "center", gap: "8px", padding: "7px 14px",
                  borderRadius: "999px", background: "rgba(251,146,60,0.08)", border: "1px solid rgba(251,146,60,0.22)"
                }}>
                  <span style={{ ...lbl, fontSize: "8px", color: "rgba(251,146,60,0.6)" }}>Bugs</span>
                  <span style={{ ...mono, fontSize: "12px", fontWeight: 700, color: "#fdba74" }}>30</span>
                </div>
                <div style={{
                  display: "flex", alignItems: "center", gap: "8px", padding: "7px 14px",
                  ...
                  <span style={{ ...mono, fontSize: "12px", fontWeight: 700, color: "#34d399" }}>150 pts</span>
                </div>
              </div>
            </div>
            <p style={{
              ...
              Review all rules carefully before entering the debugging arena. Once you continue, the live Round 3 workflow begins.
            </p>
          </div>
        </div>
            ...
            {RULES.map((rule, i) => (
              <motion.div key={i}
                ...
                style={{
                  ...
                  background: ruleExpanded === i ? "rgba(56,189,248,0.07)" : "rgba(255,255,255,0.02)",
                  border: ruleExpanded === i ? "1px solid rgba(56,189,248,0.25)" : "1px solid rgba(255,255,255,0.05)",
                }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  ...
                  <div style={{
                    ...
                    background: ruleExpanded === i ? "rgba(56,189,248,0.15)" : "rgba(255,255,255,0.04)",
                    border: ruleExpanded === i ? "1px solid rgba(56,189,248,0.3)" : "1px solid rgba(255,255,255,0.07)",
                    color: ruleExpanded === i ? "#38bdf8" : "rgba(148,163,184,0.45)",
        ...
        <div style={{ ...cardBase, padding: "20px 22px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <label style={{ display: "flex", alignItems: "flex-start", gap: "12px", cursor: "pointer" }}>
            <div onClick={() => handleAgree(!agreed)} style={{
            ...
            <span style={{ fontSize: "12.5px", color: "rgba(203,213,225,0.72)", lineHeight: 1.6 }}>
              I have read and agree to the Round 3 rules and want to continue to the debugging arena.
            </span>
          </label>
